      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center min-h-[280px] md:min-h-[360px]">
        ...
        <div className="px-6 md:px-12 py-10 md:py-0 order-2 md:order-1 z-10">
          {block.eyebrow && (
            <p
              className={cn(
                "text-[13px] font-medium mb-2 tracking-wide",
          ...
          <h1
            className={cn(
              "text-[32px] md:text-[44px] font-bold leading-[1.05] mb-3",
          ...
          {block.subhead && (
            <p
              className={cn(
                "text-[14px] mb-6 max-w-sm leading-relaxed",
          ...
          <Link href={href}>
            <button
              className={cn(
                "h-11 px-6 rounded-[var(--radius-sm)] text-[13px] font-semibold border transition-colors",
                dark
            ...
            <>
              ...
              <div
                className={cn(
                  ...
                  // Mobile gradient: bottom to top fade
                  "bg-gradient-to-t from-transparent via-transparent to-current md:bg-none",
                  // Desktop gradient: right to left fade
                  "md:bg-gradient-to-r md:from-current md:via-transparent md:to-transparent"
                )}
                style={{
                  color: dark ? "#0a0a0a" : "var(--color-bg)",
                }}
              />
            </>
          ) : (
