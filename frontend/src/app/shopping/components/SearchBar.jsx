  ...
  return (
    ...
    <InputGroup>
      ...
      <InputGroupAddon align="inline-end">
        <InputGroupButton variant="secondary"  className={"bg-primary text-white"}onClick={()=>onSearch(query)}>{loading ? <Spinner /> : <Search className="text-white"/>}</InputGroupButton>
      </InputGroupAddon>
    </InputGroup>
      {/* <Input
