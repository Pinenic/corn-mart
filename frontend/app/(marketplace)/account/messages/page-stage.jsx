...
export default function MessagesPage() {
  ...
  return (
    ...
    >
      ...
      {!selectedId && (
        <div
          className="md:hidden flex items-center justify-between px-4 py-3 border-b bg-white flex-shrink-0"
      ...
      {/* Two-panel layout */}
      <div
        className="flex flex-1 overflow-hidden bg-white border-t"
        style={{ borderColor: "var(--color-border)" }}
      >
        ...
        >
          {/* Desktop header */}
          <div
            className="hidden md:flex items-center justify-between px-4 py-3.5 border-b"
            style={{ borderColor: "var(--color-border)" }}
          >
            <div>
              <h1
