...
function FilterBar({ filters, onChange }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {/* Adjustments toggle */}
      <label
        className="flex items-center gap-2 h-9 px-3 rounded-xl border cursor-pointer text-[12px] font-medium select-none"
        style={{
          borderColor: "var(--color-border-md)",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <p
          ...
          style={{ color: "var(--color-text-muted)" }}
        >
          {formatDate(entry?.entry_date)} · {entry?.quantity} units ·{" "}
        ...
        <p
          ...
          style={{ color: "var(--color-text-secondary)" }}
        >
          This cannot be undone. The entry will be permanently removed from your
          journal.
        </p>
...
function ColHeader({ label, field, sort, onSort, className }) {
  ...
  return (
    <th
      className={cn(
        "text-left py-3 px-4 cursor-pointer select-none group",
        className
      )}
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        >
                          {entry.product?.thumbnail_url ? (
                            <img
                              src={entry.product.thumbnail_url}
                              alt=""
                        ...
                        <div className="min-w-0">
                          <p
                            className="text-[13px] font-semibold truncate max-w-[160px]"
                            style={{ color: "var(--color-text-primary)" }}
                          >
        ...
        {totalPages > 1 && (
          ...
          >
            <p
              ...
              style={{ color: "var(--color-text-muted)" }}
            >
              {total.toLocaleString()} entr{total !== 1 ? "ies" : "y"} · Page{" "}
              {page} of {totalPages}
            </p>
            <div className="flex items-center gap-1.5">
              <button
