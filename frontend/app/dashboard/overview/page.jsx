...
import { Card, SectionHeader, Badge, KpiCard } from "@/components/ui";
import {
  QueryState,
  SkeletonKpiGrid,
  SkeletonCard,
        ...
        <Card noPadding>
          ...
          >
            {recentOrders.map((order) => (
              <div
                key={order.id}
                className=" transition-colors duration-150 hover:bg-[var(--color-bg)] px-4 py-3"
